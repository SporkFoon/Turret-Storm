...
class Enemy:
    ...
    def draw(self, surface):
        ...
        if self.slow_timer > 0:
            ...
            pygame.draw.circle(aura, (120, 200, 255, 70), (self.size * 3 // 2, self.size * 3 // 2), self.size + 4)
            surface.blit(aura, (x - self.size * 3 // 2, y - self.size * 3 // 2 + bob))
        ...
        if sprite is not None:
            ...
            if self.slow_timer > 0:
                tint = sprite.copy()
                tint.fill((80, 160, 230, 0), special_flags=pygame.BLEND_RGBA_MULT)
                tint.fill((40, 80, 140, 0), special_flags=pygame.BLEND_RGBA_ADD)
            ...
            color = self.color
            if self.slow_timer > 0:
                color = (max(0, color[0] - 60), max(0, color[1] - 30), min(255, color[2] + 80))
